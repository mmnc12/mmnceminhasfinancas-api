...
import com.mmnce.minhafinancasmmnce.api.dto.AtualizaStatusDTO;
import com.mmnce.minhafinancasmmnce.api.dto.LancamentoDTO;
	...
	public ResponseEntity atualizarStatus(@PathVariable("id") Long id, @RequestBody AtualizaStatusDTO dto) {
		return service.obterPorId(id).map(entity -> {
			...
			if (statusSelecionado == null) {
				return ResponseEntity.badRequest()
						.body("Não foi possível atualizar ao status do lancamento, envie um status válido.");
			}
